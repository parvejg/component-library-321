  ...
  return (
    <Layout>
      <div className="inputs-wrapper">
        ...
        <TextInput />
        <div>
          <iframe   title="text-input-iframe" className="input-carbon"
        ...
        <PasswordInput />
        <div>
          <iframe   title="password-input-iframe"  className="input-carbon"
        ...
        <DateInput />
        <div>
          <iframe   title="date-input-iframe"  className="input-carbon"
